...
return [
    'ssh_keys' => [
        ...
        'private_key_help' => 'Se encripta automáticamente al guardar. Puedes generar claves después de crear el host.',
        'public_key_help' => 'Se encripta automáticamente al guardar. Esta clave debe añadirse al servidor remoto.',
        'generation_notice_title' => 'Generación de Claves SSH',
        'generation_notice_body' => 'Primero guarda el host. Después podrás generar las claves SSH automáticamente desde la página de edición usando el botón "Generar Claves SSH".',
