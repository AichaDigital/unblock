...
>
    <div tabindex="0" role="button" class="btn btn-ghost btn-sm btn-circle bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600 shadow-lg" aria-label="Cambiar tema">
