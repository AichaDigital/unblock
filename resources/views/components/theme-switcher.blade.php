...
>
    <div tabindex="0" role="button" class="btn btn-ghost btn-sm btn-circle backdrop-blur-sm border shadow-lg" style="background-color: rgba(255, 255, 255, 0.95); border-color: #d1d5db;" aria-label="Cambiar tema">
